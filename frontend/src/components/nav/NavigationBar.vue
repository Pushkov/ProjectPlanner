<template>
    <div>
        <b-navbar toggleable="lg" type="dark" variant="secondary">
            ...
            <b-collapse id="nav-collapse" is-nav class="border border-warning">
                <b-navbar-nav>
                    <b-nav-item href="#">
                ...
                <b-form-select
                        v-model="getLocale"
                        class="ml-auto w-auto text-secondary border border-primary rounded-lg"
                        value-field="value"
                        text-field="value"
        ...
        computed: {
            ...
            getLocale: {
                ...
                set: function (newValue) {
                    this.SET_APPLICATION_LOCALE(newValue)
                }
            }
        },
